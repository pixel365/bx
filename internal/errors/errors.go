...
var (
	...
	ErrInvalidChangelogSettings = errors.New("invalid changelog settings")
	ErrChangelogFromValue       = errors.New("changelog from: value is required")
	ErrChangelogToValue         = errors.New("changelog to: value is required")
